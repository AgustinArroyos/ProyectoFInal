...
public class CampoJpaController implements Serializable {
    ...
    public void create(Campo campo) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findCampo(campo.getCodCampo()) != null) {
                throw new PreexistingEntityException("Campo " + campo + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
